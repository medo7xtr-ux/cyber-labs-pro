    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='المجموعات التي ينتمي إليها هذا المستخدم.', related_name='custom_user_set', related_query_name='custom_user', to='auth.group', verbose_name='المجموعات')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='الصلاحيات المحددة لهذا المستخدم.', related_name='custom_user_set', related_query_name='custom_user', to='auth.permission', verbose_name='صلاحيات المستخدم')),
            ],
            options={
                'verbose_name': 'مستخدم',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=100, verbose_name='المكان')),
                ...
                ('dark_mode', models.BooleanField(default=False, verbose_name='الوضع الداكن')),
